...
cant_ed<-c(ed_1,ed_2,ed_3,ed_4)

end_grupE <- as.data.frame(cbind(agrup,cant_end,cant_ed,totalEND))

end_grupE$cant_end <- as.numeric(cant_end)

end_grupE$total <- cant_end+cant_ed
end_grupE$tasa <- round((end_grupE$cant_end*100)/end_grupE$total,2)
